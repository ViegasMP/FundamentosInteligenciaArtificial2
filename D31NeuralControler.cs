...
public class D31NeuralControler : MonoBehaviour
{
    ...
    public float GetScoreBlue()
    {
        ...
        //------ fitness ControlTheBallToAdversaryGoal ------

        fitness = hitTheBall * 15000f - distanceToBall.Average() * 15000f - distanceToAdversaryGoal.Average() * 2000f - distancefromBallToAdversaryGoal.Average() * 12000f;

        //------ fitness Defense ------

        /*
        float distance = (float)(Math.Exp(distanceTravelled));
        float distanceGoals = (float)(Math.Pow(2, distancefromBallToAdversaryGoal.Average()) * 20000 - 10000 * Math.Pow(1 / 2, distanceToMyGoal.Average()));
        if (GoalsOnMyGoal > 0)
        {
        ...
        {
            fitness = distance * 10000 + hitTheBall * 400000 + distanceGoals * 10000 - hitTheWall * 2000;
        }
        */
        ...
        /*
         distanceGoals = (float)(Math.Pow(2, distancefromBallToAdversaryGoal.Average()) * 10000.0f - Math.Pow(1 / 2, distanceToMyGoal.Average()) * 1000.0f);
         fitness = hitTheBall * 15000f - distanceToBall.Average() * 15000f - distanceToAdversaryGoal.Average() * 2000f - distancefromBallToAdversaryGoal.Average() * 12000f;
        */
    ...
    public float GetScoreRed()
    {
        ...
        */
        ...
        /*
         distanceGoals = (float)(Math.Pow(2, distancefromBallToAdversaryGoal.Average()) * 10000.0f - Math.Pow(1 / 2, distanceToMyGoal.Average()) * 1000.0f);
         fitness = hitTheBall * 10000.0f + distanceGoals - hitTheWall * 500.0f - GoalsOnMyGoal * 500f;
        */
