...
public class HillClimber : MetaHeuristic
{
    ...
    // parametrização das variáveis da mutação gaussiana
	...
	public override void Step()
	{
		...
		for (int i = 0; i < populationSize ; i++) {
            ...
            tmpRed.Mutate (mutationProbabilityRedPopulation, mean, standard_deviation);
            tmpBlue.Mutate(mutationProbabilityBluePopulation, mean, standard_deviation);
